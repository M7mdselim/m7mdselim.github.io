...
function App() {
  ...
  const stats = [
    ...
    { icon: Award, label: "Awards", value: "6" }
  ];
  ...
  const filteredProjects = selectedCategory === 'all' 
    ...
    const handleSubmit = (e) => {
      ...
      const whatsappUrl = `https://wa.me/01155003537?text=${encodedMessage}`; // Replace with your phone number
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="flex flex-col items-start space-y-6">
            ...
            <p className="text-xl text-gray-300 max-w-2xl">
              Specializing in AI Development, Frontend Engineering, and Desktop Applications. 
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group bg-gray-900/50 p-8 rounded-xl hover:bg-gray-900 transition-all hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-semibold mb-4">Desktop Applications</h3>
              <p className="text-gray-300 leading-relaxed">
                Developing cross-platform desktop applications using C# windows Form Application and native technologies.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="space-y-12">
            <div className="relative pl-8 border-l-2 border-blue-400 group">
              ...
              <div className="mb-1 text-blue-400 font-medium">2022 - Present</div>
              <h3 className="text-2xl font-semibold mb-2 group-hover:text-blue-400 transition-colors">
                Exam's Invigilator - British Council (Part-Time)
              </h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div className="relative pl-8 border-l-2 border-blue-400 group">
              ...
              <p className="text-gray-300 leading-relaxed">
              Developed and deployed six Windows application forms to streamline internal processes. Provided technical support, maintained IT infrastructure, and optimized system performance within a structured military environment.
              </p>
            </div>
